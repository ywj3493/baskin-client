...
import BettingPlayScene from "./BettingPlayScene";
//types
import {
    PlayLog,
 ...
 * @param gameCount 
 */
export interface BettingPlayBoardSetting {
    numEnd : number, 
    maxCall : number, 
    numPlayer : number, 
    gameCount : number,
...
export function BettingPlayBoard(props: {
        bettingPlayBoardSetting : BettingPlayBoardSetting
    }) {
    const {bettingPlayBoardSetting} = props;
    const {numEnd, maxCall, numPlayer, gameCount, betAmount} = bettingPlayBoardSetting;
    ...
    return <Box sx={{p: 3}}>
        ...
        <BettingPlayScene betAmount={3} numPlayer={3} maxCall={3}></BettingPlayScene>
    </Box>
}